...
RUN cd /tmp/ecell4 ; PREFIX=/usr/local PYTHONPATH=/usr/local/lib/python2.7/dist-packages CPLUS_INCLUDE_PATH=/tmp/ecell4/odeint-v2 bash /tmp/ecell4/install.sh ode ode_python
EXPOSE 8888
